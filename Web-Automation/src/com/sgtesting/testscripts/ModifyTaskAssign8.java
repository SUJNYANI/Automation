package com.sgtesting.testscripts;
	...
	public class ModifyTaskAssign8{
		...
		static void createTask()
		{
			try
			{
				...
				Thread.sleep(2000);
				oBrowser.findElement(By.xpath("//*[@id=\'createTasksPopup_createTasksTableContainer\']/table/tbody/tr[1]/td[1]/input")).sendKeys("suj");
				Thread.sleep(2000);
		...
		static void modifyTask()
		{
			try
			{
				...
				Thread.sleep(2000);
				oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[2]/div[1]/div[2]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("db");
				Thread.sleep(2000);
