...
public class assign2 {
	...
	static void creatuser123()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.name("password")).sendKeys("1212");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("1212");
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'userDataLightBox_commitBtn\']/div")).click();
			Thread.sleep(2000);
	...
	static void loginasusername2()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.name("pwd")).sendKeys("1212");
			Thread.sleep(2000);
			oBrowser.findElement(By.id("loginButton")).click();
			Thread.sleep(2000);			
		}
	...
	static void modifyuser123()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.name("password")).sendKeys("101010");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("passwordCopy")).sendKeys("101010");
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'userDataLightBox_commitBtn\']/div/span")).click();
			Thread.sleep(2000);
		}
	...
	static void user3loginwithnewpassword()
	{
		try
		{
			oBrowser.findElement(By.name("username")).sendKeys("user3");
			Thread.sleep(2000);
			oBrowser.findElement(By.name("pwd")).sendKeys("101010");
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//*[@id=\'loginButton\']/div")).click();
			Thread.sleep(2000);
		}
